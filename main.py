...
data = (val_bow_features, val_labels, test_bow_features, test_labels)
data = (train_bow_features, train_labels, val_bow_features, val_labels)
fix_L = 0.01
peg_tune_results_T = utils.tune_pegasos_T(fix_L, Ts, *data)
print('Pegasos valid: tune T', list(zip(Ts, peg_tune_results_T[1])))
...
theta, theta_0 = sa.pegasos(train_bow_features, train_labels, 25, 0.01)
pred_test_labels = sa.classify(test_bow_features, theta, theta_0)
print(sa.accuracy(pred_test_labels, test_labels))
